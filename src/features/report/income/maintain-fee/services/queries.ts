...
export const useGetMaintainFeeIncomeReport = (filter: MaintainFeeFilter) => {
  return useQuery({
    ...
    queryFn: () =>
      maintainFeeIncomeReportApiService.getMaintainFeeIncomeReport(filter),
    refetchOnWindowFocus: false,
  });
};
export const useGetMaintainFeeIncomeMonthlyReport = (
  filter: MaintainFeeFilter
) => {
  return useQuery({
    queryKey: ["maintain-income-monthly-report", filter],
    queryFn: () =>
      maintainFeeIncomeReportApiService.getMaintainFeeIncomeMonthlyReport(
        filter
      ),
    refetchOnWindowFocus: false,
  });
