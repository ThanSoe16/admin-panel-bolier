...
const FirstTimeContainer: React.FC<NoDataProps> = ({
  ...
  return (
    ...
    >
      {!hideIcon && (
        <Image
          src={icon ? icon : isError ? '/invoice/info-invoice.svg' : '/invoice/invoice.svg'}
          alt="empty"
          width={100}
          height={100}
      ...
      <p className="text-default-secondary text-lg font-bold text-center"> {title} </p>

      <p className="text-default-secondary text-base text-center">{description}</p>
