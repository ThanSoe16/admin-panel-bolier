...
export const MaintenanceStatusCard = ({
  ...
  const description = isActive? "Are you sure you want to change the maintenance mode as “Off”? Once you turn it off, all services in the system will back to work as usual." : "Are you sure you want to change the maintenance mode as “On”? Once you turn it on, all users will not be able to login, use or manage their accounts as well as access One Site Services."
  return <>
  {!isActive ? (
    ...
    <div className='w-full rounded-xl bg-error-secondary p-4 lg:p-6 relative flex flex-col md:flex-row items-start md:items-start justify-between gap-2'>
      ...
      <div className='flex-1 flex flex-col items-start justify-center gap-1 lg:pr-[120px]'>
        ...
        <p className='w-full'>Users will not be able to login, use or manage their accounts until the system is back to online.</p>
