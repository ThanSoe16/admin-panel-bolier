...
import { useGetHostingSaleHistory } from "@/features/sale-histoy/hosting/services/queries";
import dayjs from "dayjs";

const HostingSales = () => {
  const { query, start, setStart, end, setEnd, word } = usePagination();
  const { data, isLoading } = useGetHostingSaleHistory({
  ...
  return (
    <div>
      <PageTitle> Hosting Sales </PageTitle>
