...
import {
  useGetHostingNotificationCounts,
  useGetHostingNotificationSettings,
} from "@/features/notification/hosting/services/queries";
...
const HostingNotification = () => {
  const { data, isLoading } = useGetHostingNotificationSettings();
  const { data: NotificationCounts } = useGetHostingNotificationCounts();
  ...
  return (
    <div>
      <PageTitle> Hosting Renew </PageTitle>
      <MetaBox
        iconUrl="/notification/hosting.svg"
        type="hosting"
...
export default HostingNotification;
