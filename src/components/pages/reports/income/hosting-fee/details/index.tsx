...
import { hostingFeeDailyColumnDefs, hostingFeeTypeColumnDefs } from '../components/columnDefs';

const IncomeReportHostingFeeDetail = ({ type }: { type: 'daily' | 'monthly' | 'yearly' }) => {
  ...
  return (
    <div className="flex flex-col w-full gap-4">
      ...
      <div className="mt-4 table-container">
        <DataTable
          isShowNo={false}
          isLoading={type == 'daily' ? hostingFeeDaily.isLoading : hostingFeeMonthly.isLoading}
          data={
            type == 'daily'
