...
const IncomeReportMaintainFeeDetail = ({
  type,
}: {
    ...
    () => [
      {
        ...
        total:
          maintainFeeDaily?.data?.body?.data?.totalMaintainFees?.total ?? 0,
        count:
          maintainFeeDaily?.data?.body?.data?.totalMaintainFees?.count ?? 0,
      },
      {
      ...
      },
      {
        ...
        total:
          maintainFeeDaily?.data?.body?.data?.renewMaintainFees?.total ?? 0,
        count:
          maintainFeeDaily?.data?.body?.data?.renewMaintainFees?.count ?? 0,
      },
    ],
    ...
    <div className="flex flex-col w-full gap-4">
      ...
      <div className="mt-4">
        <DataTable
          ...
          isLoading={
            type == "daily"
              ? maintainFeeDaily.isLoading
              : maintainFeeMonthly.isLoading
          }
          data={
            type == "daily"
