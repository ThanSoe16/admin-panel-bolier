...
const IncomeReportServerFeeDetail = ({
  type,
}: {
  ...
  return (
    <div className="flex flex-col w-full gap-4">
      ...
      <DataTable
        data={upperTableData ?? []}
        columns={serverFeeTypeColumnDefs}
        isShowNo={false}
      />
      <div className="mt-4">
        <DataTable
          ...
          isLoading={
            type == "daily"
              ? serverFeeDaily?.isLoading
              : serverFeeMonthly?.isLoading
          }
          data={
            type == "daily"
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
              ...
              {type === "daily" && (
                <div className="flex flex-col md:flex-row md:items-center gap-2 flex-1 max-w-[340px]">
                  <SearchInput
                    placeholder="Search by User Name or Store Name"
                    className="w-full"
                  />
                </div>
              )}
