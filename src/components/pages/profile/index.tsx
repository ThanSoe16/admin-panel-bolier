...
const Profile = () => {
  ...
  return (
    <div className="">
        ...
        <CardContent>
          <div className="flex flex-row gap-4 justify-start items-start">
            ...
            <div className="flex flex-col justify-start items-start gap-2">
              <p className="text-default font-bold text-xl md:text-2xl ">
                {' '}
                {data?.body?.data?.name}{' '}
              </p>
              <Status
              ...
              <div className="flex flex-row justify-start items-center gap-0">
                ...
                <p className="text-default text-sm md:text-base">
                  {' '}
      ...
      {open && <LogoutDialog open={open} handleClose={() => setOpen(false)} />}
    </div>
  );
};
